<head>
  ...
  <link rel="stylesheet" href="<?php echo URL . 'app/assets/vendors/jvectormap/jquery-jvectormap.css'; ?>">
  <link rel="stylesheet" href="<?php echo URL . 'app/assets/vendors/flag-icon-css/css/flag-icon.min.css'; ?>">
  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="<?php echo URL . 'home/onShow' ?>"><img src="<?php echo URL . 'app/img/logo.png'; ?>" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="<?php echo URL . 'home/onShow' ?>"><img src="<?php echo URL . 'app/img/logo-mini.png'; ?>" alt="logo" /></a>
      </div>
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="">
            ...
            <span class="menu-title">Montar Curso</span>
          </a>
        </li>
